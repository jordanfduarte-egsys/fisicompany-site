...
( function(b) {
		...
		var a = {};
		a.fileapi = b("<input type='file' accept='.png,.jpg,.jpeg'/>").get(0).files !== undefined;
		...
		b.fn.uploadFile = function(r) {
			...
			function p(x, A, C, t) {
				...
				var u = "<input type='file' id='" + z + "' name='" + C.fileName + "'  accept='.jpg,.jpeg,.png'/>";
				if (C.multiple) {
					if (C.fileName.indexOf("[]") != C.fileName.length - 2) {
						C.fileName += "[]"
					}
					u = "<input type='file' id='" + z + "' name='" + C.fileName + "' accept='.png,.jpg,.jpeg' multiple/>"
				}
