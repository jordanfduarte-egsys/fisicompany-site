...
(function ($) {
    ...
    var feature = {};
    feature.fileapi = $("<input type='file' accept='.png,.jpg,.jpeg'/>").get(0).files !== undefined;
    ...
    $.fn.uploadFile = function (options) {
        ...
        this.hide();
        this.errorLog = $("<div class='clear_both'></div>"); //Writing errors
        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
            ...
            var fileInputStr = "<input type='file' id='" + fileUploadId + "' name='" + s.fileName + "' accept='.png,.jpg,.jpeg'/>";
            if (s.multiple) {
                if (s.fileName.indexOf("[]") != s.fileName.length - 2) // if it does not endwith
                {
                    s.fileName += "[]";
                }
                fileInputStr = "<input type='file' id='" + fileUploadId + "' name='" + s.fileName + "' accept='.png,.jpg,.jpeg' multiple/>";
            }
