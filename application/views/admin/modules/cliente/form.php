...
Importante: </b>mínino (6 digitos)
    ...
    <label for="acesso_cliente">
        <input name="acesso_cliente" type="checkbox"  <?php echo ((isset($usuario[0]->acesso_cliente) and $usuario[0]->acesso_cliente)  ? "checked" : "")?>  tabindex="8" value="1"/>&nbsp;Acesso Cliente        
    </label>
